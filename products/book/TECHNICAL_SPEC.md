...
# =============================================================================
# VERTICAL HIERARCHY — Контекст программы в Книге 2 (без скобок)
# =============================================================================
# Принцип: Иерархия через размер/вес, не через пунктуацию [brackets].
#
# БЫЛО:  ## [Отношения] Люди рядом
# СТАЛО: ### Отношения          ← контекст (меньше, серый)
#        ## Люди рядом          ← главное (больше, чёрный)

VERTICAL_HIERARCHY = {
    "program_context": {
        "heading_level": "###",       # H3 — меньше чем кластер
        "font_size": "14pt",
        "font_weight": 400,           # Regular — отступает
        "color": "#555555",           # Medium gray — контекст
    },
    "cluster_title": {
        "heading_level": "##",        # H2 — основной
        "font_size": "18pt",
        "font_weight": 600,           # Bold — главное
        "color": "#000000",           # Black — акцент
    }
}
