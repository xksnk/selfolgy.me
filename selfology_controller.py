...
from selfology_bot.bot.handlers.menu_chat import MenuChatHandlersMixin  # 🔧 Extracted handlers
...
class SelfologyController(OnboardingHandlersMixin, ProgramHandlersMixin, MenuChatHandlersMixin):
    """Простой контроллер Selfology бота

    Наследует от:
    - OnboardingHandlersMixin: handlers онбординга
    - ProgramHandlersMixin: handlers программ
    - MenuChatHandlersMixin: handlers меню и чата
    """
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    # MENU & CHAT HANDLERS moved to: selfology_bot/bot/handlers/menu_chat.py
    # Inherited from MenuChatHandlersMixin (240 lines extracted)
    # ═══════════════════════════════════════════════════════════════════════════
